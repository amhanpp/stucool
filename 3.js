...
[rewrite_local]
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-response-body https://raw.githubusercontent.com/amhanpp/stucool/main/3.js
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-request-header https://raw.githubusercontent.com/amhanpp/stucool/main/3.js
...
if (typeof $response == "undefined") {
  ...
  const app = 'gd';const list = { 'jizhi':{ name: 'jizhi_vip',id: 'jizhi_vip'},'gd':{name: 'pro'， id: 'cc.anybox.Anybox.annual'}，'Snipd':{ name: 'premium'， id: 'snipd_premium_1y_7199_trial_2w_v2'},};
  const data = {
